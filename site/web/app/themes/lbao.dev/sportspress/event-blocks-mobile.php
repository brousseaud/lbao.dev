...
<?php # Required for DataTables ?>
				...
				foreach ( $data as $event ):
					...
					<div class="column">
						...
						<div class="row">
							<div class="small-7 games columns">
							<div class="row">
					...
					<!--	</div>-->
						...
						<div class="small-5 games results columns">
							...
							<div class="vertical-align">
								<?php echo str_replace(" min", "", sp_add_link( '<span class="sp-result">' . implode( '</span> - <span class="sp-result">', apply_filters( 'sportspress_event_blocks_team_result_or_time', sp_get_main_results_or_time( $event ), $event->ID ) ), $permalink, $link_events )); ?></div>
							<?php
								break;
						};?>
						</div>
