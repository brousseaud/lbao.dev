...
?>
				...
				foreach ( $data as $event ):
					...
					endforeach;
					?>
					<div class="scoreboard large-12 medium-12 small-12 columns box">
					...
					<time class="sp-event-date" datetime="<?php echo $event->post_date; ?>"><?php echo get_the_time( get_option( 'date_format' ), $event ); ?></time>
						...
						<div class="row game-team-visit">
							<div class="large-3 medium-3 small-3 team columns">
							<?php echo /*implode(*/ $logos[0] /*, ' ' );*/ ?>

							</div>
							<div class="large-3 medium-3 small-3 score columns">
							<?php 
					...
					<div class="large-6 medium-6 small-6 columns statut">
						<a href="<?php echo get_post_permalink( $event ); ?>">Sommaire</a>
					</div>
</div>
						</div>
							<!--<time class="sp-event-date" datetime="<?php echo $event->post_date; ?>"><?php echo get_the_time( get_option( 'date_format' ), $event ); ?></time>
