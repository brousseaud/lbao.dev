...
<div class="large-12">
				...
				foreach ( $data as $event ):
					...
					endforeach;
					?>
						<div class="large-12 game-time column">
							<h2><?php echo get_the_time( get_option( 'time_format' ), $event ); ?></h5>
						</div>
						<?php 
							$teamNames = explode(' vs ', $event->post_title, 2);
						?>
						<div class="row game-team-visit">
							<div class="large-10 team columns">
							<?php echo /*implode(*/ $logos[0] . " " . $teamNames[0]/*, ' ' );*/ ?>

							</div>
							<div class="large-2 score columns">
							<?php 
